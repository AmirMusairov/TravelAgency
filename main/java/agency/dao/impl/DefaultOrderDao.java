...
public class DefaultOrderDao implements OrderDao {
	...
	private static OrderData getOrderFromDb(ResultSet rs) throws SQLException {
		...
		return new OrderData(new OrderData.OrderBuilder(userId, orderId, userEmail).setTourId(tourId).setTourName(tourName)
				.setTourPrice(tourPrice).setHotelId(hotelId)
